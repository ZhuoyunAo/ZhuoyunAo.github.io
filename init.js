      ...
      $.ajax($.extend({}, options, {
        ...
        error: function(xhr, status, error) {
          ...
          if (rateLimited && attempt < 3) {
            ...
            gdeltAjax(options, attempt + 1, wait).then(resolve).catch(reject);
            return;
          }
...
function hash(){
  ...
  if(init_args[0] == 'compare') {
    ...
    compareLoadTotal = init_args.length - 1;
    setCompareLoadStatus(compareCompleted, compareLoadTotal, false);
